...
<div class="narrative-figure">
  <div style="display:flex; gap:14px; flex-wrap:wrap; justify-content:center;">
    <img src="assets/projects/motion-scatter-chamber.png" alt="" onerror="this.style.display='none';" style="max-width:100%; width:280px; height:auto; border:1px solid var(--grid-line); background:#fff; object-fit:contain;">
    <img src="assets/projects/motion-scatter-lapangan1.png" alt="" onerror="this.style.display='none';" style="max-width:100%; width:280px; height:auto; border:1px solid var(--grid-line); background:#fff; object-fit:contain;">
    <img src="assets/projects/motion-scatter-lapangan2.png" alt="" onerror="this.style.display='none';" style="max-width:100%; width:280px; height:auto; border:1px solid var(--grid-line); background:#fff; object-fit:contain;">
  </div>
  <figcaption>Scatter plot korelasi antara Motion Index dengan Deviasi Pembacaan — Uji Chamber (kiri), Uji Lapangan 1 (tengah), dan Uji Lapangan 2 (kanan)</figcaption>
</div>
...
<div class="narrative-section">
  ...
  <p style="margin-top:16px;">Lebih lanjut, dilakukan analisis korelasi linear (Pearson's r) antara intensitas gerakan (diwakili metrik Motion Index dari algoritma HAR) terhadap besaran deviasi absolut sensor (|E|):</p>
  <ul class="narrative-list">
    <li><b>Skenario Chamber:</b> Ditemukan korelasi positif yang kuat (r = 0.863 untuk PM<sub>2.5</sub> dan r = 0.580 untuk PM<sub>10</sub>).</li>
    <li><b>Skenario Lapangan:</b> Korelasi positif ini tervalidasi semakin kuat (hingga r = 0.992 untuk PM<sub>2.5</sub> pada Lapangan 2). Semakin ekstrem guncangannya (seperti aktivitas Berlari), semakin besar pula penyimpangan pembacaan alat.</li>
